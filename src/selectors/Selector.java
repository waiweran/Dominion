...
public class Selector {
	 ...
	 * @param game the DominionGame to communicate with about the result of the selection
	...
	/**
	 * Shows a dialog from the tavern mat.
	 ...
	 * @param largeView True to display the card large, false to display small.
